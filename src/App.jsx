    ...
    <div className="App">
      <div className="h-screen w-screen flex justify-center items-center bg-gray-300">
        <div className="card h-[500px] w-80 bg-gray-100 rounded-lg shadow-md">
          <img
            className="h-2/5 w-full rounded-t-lg bg-slate-200"
            src={drawers}
            alt="cover"
          />
          <article className="h-3/5 flex flex-col justify-between text-gray-600 text-sm ">
            ...
            <div className={`${active ? "bg-[#4A566C]" : ""} rounded-b-lg`}>
              <div className="flex justify-between m-5 rounded-lg">
                {active ? (
                  <div className="flex">
                    <div className="flex items-center h-10 text-gray-400 tracking-[0.4em] uppercase ">
                      share
                    </div>
                    <div className="w-28 ml-4 flex justify-evenly items-center">
                      <svg
